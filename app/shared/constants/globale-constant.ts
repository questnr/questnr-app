export class GlobalConstants {
  ...
  public static questnrFeedTitle = 'Questnr Feed';
  public static postTitle = 'Post | Questnr';
  public static postBlogTitle = 'Blog | Questnr';
  public static postQuestionTitle = 'Question | Questnr';
